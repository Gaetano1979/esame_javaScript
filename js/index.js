  ...
  assignaValore:function(selector){
    if (selector.id!=null && selector.id.length<2 ) {
      if (tasti.display.innerHTML==0 && prova==true|| costante==1) {
        ...
        prova=false;
      }else if (tasti.display.innerHTML.length<8) {
        if(prova==false){
          tasti.display.innerHTML+=selector.id;
        }
      }
...
var Eventos={
  ...
  tastiFunzioni:{
    ...
    tastoOn:function(){
      if (tasti.display.innerHTML=="" || tasti.display.innerHTML==null){
        tasti.display.innerHTML=0;
      }else if(tasti.display.innerHTML!=0){
        tasti.display.innerHTML=0;
        prova=true;
      }else if(tasti.display.innerHTML==0){
        tasti.display.innerHTML="";
